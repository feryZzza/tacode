...
We evaluate participant-disjoint in-distribution and held-out-task trials under six training-time fault types and three unseen fault generators.
...
% TODO: Replace every placeholder below after the three-seed suite is complete.
Relative to a split-matched deterministic TCN, the proposed method changes clean moment RMSE by \textbf{[TBD]}, reduces fault-condition wrong-direction assistance by \textbf{[TBD]}, and retains \textbf{[TBD]} of clean aligned torque across three seeds.
...
% TODO: Before submission, specify the final confidence interval or non-parametric test and correction procedure.
...
% Populate from reports/v2_paper_suite/core_aggregate.tsv and fair_baseline_aggregate.tsv.
Table~\ref{tab:accuracy} compares the proposed model with the split-matched deterministic TCN on uncorrupted trials.
On ID tasks, reliability training changes RMSE from \textbf{[TBD]} to \textbf{[TBD]} Nm/kg (paired difference \textbf{[TBD]}), while the corresponding OOD values are \textbf{[TBD]} and \textbf{[TBD]}.
The probabilistic model obtains coverage ECEs of \textbf{[TBD]} and \textbf{[TBD]} on ID and OOD tasks, respectively.
Together with the paired confidence intervals, these results determine whether fault-aware training preserves nominal accuracy or introduces a measurable robustness cost.
...
\midrule
Deterministic & ID  & [TBD] & [TBD] & -- & --\\
Proposed      & ID  & [TBD] & [TBD] & [TBD] & [TBD]\\
Deterministic & OOD & [TBD] & [TBD] & -- & --\\
Proposed      & OOD & [TBD] & [TBD] & [TBD] & [TBD]\\
\bottomrule
\end{tabular}
...
% Populate from scripts/build_aaai_tables.py output table1_detection.tsv.
...
Across faults seen during training, the fused detector reaches macro-AUROC \textbf{[TBD]} on ID tasks and \textbf{[TBD]} on held-out tasks.
For the unseen burst, partial-loss, and delay-jitter generators, the corresponding macro-AUROCs are \textbf{[TBD]} and \textbf{[TBD]}.
The strongest individual signal is \textbf{[TBD]} for \textbf{[TBD fault]}, whereas \textbf{[TBD fault]} remains the most difficult case at \textbf{[TBD]} AUROC.
...
\midrule
ID  & Insole missing & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
ID  & IMU bias & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
ID  & Burst packet loss (unseen) & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
OOD & Partial channel loss (unseen) & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
OOD & Delay jitter (unseen) & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
\bottomrule
\end{tabular}
...
% Populate from scripts/build_aaai_tables.py output table2_safety.tsv.
...
On clean ID and OOD trials, the gate retains \textbf{[TBD]} and \textbf{[TBD]} of aligned assistance, with wrong-direction changes of \textbf{[TBD]} and \textbf{[TBD]}.
Across trained fault types, gating changes the wrong-direction ratio by \textbf{[TBD]} on ID and \textbf{[TBD]} on OOD tasks; for unseen generators, the changes are \textbf{[TBD]} and \textbf{[TBD]}.
...
\midrule
ID clean & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
OOD clean & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
ID seen faults & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
ID unseen faults & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
OOD seen faults & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
OOD unseen faults & [TBD] & [TBD] & [TBD] & [TBD] & [TBD]\\
\bottomrule
\end{tabular}
...
Fault augmentation changes macro fault AUROC by \textbf{[TBD]} and clean OOD RMSE by \textbf{[TBD]}.
Adding probabilistic prediction, reconstruction, and forecasting produces successive AUROC changes of \textbf{[TBD]}, \textbf{[TBD]}, and \textbf{[TBD]}; their effects on wrong-direction torque are reported in the final column.
These paired results distinguish improvements due to exposure to corrupted inputs from those due to a particular reliability head.
...
\midrule
Deterministic & [TBD] & [TBD] & -- & --\\
+ fault augmentation & [TBD] & [TBD] & [TBD] & [TBD]\\
+ probabilistic head & [TBD] & [TBD] & [TBD] & [TBD]\\
+ reconstruction & [TBD] & [TBD] & [TBD] & [TBD]\\
+ forecasting (proposed) & [TBD] & [TBD] & [TBD] & [TBD]\\
\bottomrule
\end{tabular}
...
At the largest packet-loss rate and delay considered, fused AUROC is \textbf{[TBD]} and \textbf{[TBD]}, while the gate retains \textbf{[TBD]} of aligned assistance and changes wrong-direction torque by \textbf{[TBD]}.
...
Across leave-one-subject-out folds, the principal safety effect is \textbf{[TBD]}, indicating \textbf{[TBD interpretation after confidence intervals are available]}.
...
In our results, \textbf{[TBD signal]} is most informative for \textbf{[TBD fault family]}, whereas \textbf{[TBD signal]} contributes most under \textbf{[TBD fault family]}.
The remaining weakness on \textbf{[TBD failure mode]} shows that additional channels do not make every corruption identifiable.
...
The observed trade-off---\textbf{[TBD reduction]} wrong-direction assistance for \textbf{[TBD retention]} clean aligned assistance---should therefore be interpreted as an operating point, not as a universal safety threshold.
...
The result on \textbf{[TBD hardest fault]} is particularly informative because it exposes \textbf{[TBD whether the limitation is detection, calibration, or the gate response]}.
